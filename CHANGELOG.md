...
- SSL certificates not applied consistently to Mozart and OpenWave clients

## [2.6.1] - 2026-08-11

### Fixed

- Issues with registers with same supplier resolved to each other's client/certs

## [2.6.0] - 2026-07-29

### Added

- Support for the EnableU client
- Support for 'zaakverzoeken' endpoint

### Fixed

- Loads and loads of issues flagged by PHPStan

## [2.5.3] - 2026-06-23

### Fixed

- Make InformationObject final status check optional
